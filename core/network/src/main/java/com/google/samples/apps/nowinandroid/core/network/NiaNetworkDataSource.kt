 ...
 */
class NiaNetworkDataSource @Inject constructor(
    ...
    suspend fun getTopicChangeList(after: Int?): List<NetworkChangeList> =
        getTopics().mapToChangeList(NetworkTopic::id)

    suspend fun getNewsResourceChangeList(after: Int?): List<NetworkChangeList> =
