...
import androidx.test.uiautomator.waitAndFind
...
fun MacrobenchmarkScope.forYouWaitForContent() {
    ...
    val topicSelection = device.waitAndFind(By.res("forYou:topicSelection"), 5_000)
    // Timeout here is quite big, because sometimes data loading takes a long time!
    topicSelection.wait(untilHasChildren(), 60_000)
}
