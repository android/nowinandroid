...
class BookmarksViewModelTest {
    ...
    fun stateIsInitiallyLoading() = runTest {
        assertEquals(NewsFeedUiState.Loading, viewModel.feedUiState.value)
    }
    ...
    fun feedUiState_resourceIsViewed_setResourcesViewed() = runTest {
        ...
        assertIs<NewsFeedUiState.Success>(itemBeforeViewed)
    ...
    fun feedUiState_undoneBookmarkRemoval_bookmarkIsRestored() = runTest {
        ...
        assertIs<NewsFeedUiState.Success>(itemBeforeUndo)
