...
const val FOR_YOU_NAVIGATION_ROUTE = "for_you_route/{$LINKED_NEWS_RESOURCE_ID}"
...
fun NavController.navigateToForYou(navOptions: NavOptions? = null) {
    this.navigate(FOR_YOU_NAVIGATION_ROUTE, navOptions)
}

fun NavGraphBuilder.forYouScreen(onTopicClick: (String) -> Unit) {
    composable(
        route = FOR_YOU_NAVIGATION_ROUTE,
        deepLinks = listOf(
